...
class SlackClient
  ...
  def event(req)
    headers = {
      'X-Slack-Request-Timestamp' => req['X-Slack-Request-Timestamp'], # rubocop:disable Style/StringHashKeys
      'X-Slack-Signature' => req['X-Slack-Signature'] # rubocop:disable Style/StringHashKeys
    }
